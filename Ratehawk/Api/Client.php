...
class Client
{
    ...
    public function getHotelsDump(string $downloadDirectory): bool
    {
        ...
        $response = json_decode($this->httpClient
            ->post(Endpoints::HOTEL_INFO_DUMP, $options)
            ->getBody()
            ->getContents(),
            true,
            512,
        ...
        $tempFileName = $downloadDirectory . md5(microtime(true)) . '.zstd';
